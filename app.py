...
with tab3:
    ...
    with col_c1:
        ...
        En esta tarea utilizamos el clasificador Gamma Pydra para identificar las tres especies de pingüinos: Adelie, Chinstrap y Gentoo. Después de realizar un proceso completo de carga, exploración, limpieza y preprocesamiento de los datos el modelo logró un 89.55% de accuracy.
